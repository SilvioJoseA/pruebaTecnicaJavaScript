...
/**
 *
 * Crear una función async waitFor5() que retorne una promesa que se 
 * resuelva una vez que pasaron 5 segundos.
 * 
 * @returns {Promise<any>}
 */
 Utils.waitFor5 = function () {
...
/**
 *
 * Crear una función async waitFor3() que retorne una promesa que se 
 * resuelva una vez que pasaron 3 segundos.
 * 
 * @returns {Promise<any>}
 */
 Utils.waitFor3 = function () {
    return Utils.waitForMilliseconds(1000 * 3);
}
...
*/
Utils.waitForClick = async function () {
    const promise1 = Promise.resolve('Wait for click');
